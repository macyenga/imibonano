...
export const sendActivationCode = (user: User): void => {
	sendMail(
		...
		<a href='https://imibonano-client.onrender.com/login?activate=${user.activationCode}' style="display: inline-block; padding: 10px 20px; background-color: #0e70a5; color: #fff; text-decoration: none; border-radius: 4px;">Activate my account</a>
...
export const mailEmailUpdateLink = (email: User['email'], newUpdateRequest: EmailUpdateRequest): void => {
	sendMail(
		...
		`<h1>Hi, here you can confirm email reset!</h1>
			...
			<a href='https://imibonano-client.onrender.com/update_email?update=${newUpdateRequest.token}'>Reset email here</a>
